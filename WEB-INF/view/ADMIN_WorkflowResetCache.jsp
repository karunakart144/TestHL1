...
<% String token = null; %>
			...
			<td width = "30%">
				<table width="100%" border="0" cellpadding="3" cellspacing="0" align="right">
					<tr>
						...
						<td>
							<div>
								<input type="button" id="workflowCache" value="Reset Cache"/>
							</div>
						</td>						
					</tr>
				</table>
    ...
    <table width="80%" border="0" cellpadding="3" cellspacing="0" align="center" id="resetCache" class = "createTable">	
		<tr>		
		</tr>
	</table>	
	<script type="text/javascript" src="<%=jsDirPath%>/jquery-1.4.2.min.js"></script>
	<script type="text/javascript" src="<%=jsDirPath%>/custom/ADMIN_WorkflowResetCache.js"></script>
