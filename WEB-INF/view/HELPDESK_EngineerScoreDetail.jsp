...
<script type="text/javascript" src="<%=jsDirPath%>/custom/HELPDESK_EngineerScoreDetail.js"></script> 


<form:form modelAttribute="ScoreDetail" name="scoreDetailForm" action="HELPDESK_EngineerScoreDetail.htm" >
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class = "createTable" >
		...
		<tr>
			...
			<td>
				<form:input type="text" id="fromDate"  class="myTextInput" readonly="true"   path="FROM_DATE" ></form:input>
				<a href="#" onclick="clearDateField('fromDate')"><img src="images/clear.png" alt="Clear From Date" title="Clear From Date"/></a>
			</td>
			...
			<td>
				<form:input type="text" id="toDate" class="myTextInput" readonly="true"   path="TO_DATE" ></form:input>
				<a href="#" onclick="clearDateField('toDate')"><img src="images/clear.png" alt="Clear To Date" title="Clear To Date"/></a>
			</td>
			<td align="left">
				<input type="button" id="Go" value="Go" onclick="isValidateDate()" >
			</td>
...
<!--<div id="scoreDetDIV">
<table width="100%" class="myDataTable" id="scoreDetTBL" cellpadding="0" cellspacing="0">
<tr>
<th>Ticket Id</th>
<th>Weightage</th>
</tr>
...
<script type="text/javascript">		
         ...
         location.href = '${pageContext.request.contextPath}/HELPDESK_EngineerScoreDetail.htm?'+
