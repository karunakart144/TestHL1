var auditID,previousST,currentST,changedBY,changedDT,actionToAudit,dataToInsertAT,ticketNO,historyID,auditDataDT,fieldValue,oldVal,newVal;
	...
	$.getJSON("auditloglist.htm",{ticketNo:ticketNO,menuID:menuid},function(data){										
		if (data.status && data.status=="Error") {	
			...
			{	
				...
				dataToInsertAT +="<th>Changed By</th><th>Changed Date</th><th>Action</th></tr>"; 
				...
				for(var i=0;i<data.length;i++)
				 {
									 ...
									 dataToInsertAT += '<tr><td width="10%"><a href="#" id="showAuditInfo" onClick="getAuditDetails('+auditID+',1)">'+auditID+'</a></td>'+
											...
											'<td width="22%">'+actionToAudit+'</td></tr>';	
