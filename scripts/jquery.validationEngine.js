...
(function($) {
    ...
    $.fn.showerrormessage= function(opt) {

        var form = $(this);
		  if(!form[0]) return false;  // stop here if the form does not exist
		  
		  
		 // methods._showPrompt($("#subject"), "hello nice", "", false, "", true);
          ...
          methods._showPrompt(this, opt.message, "pass", false, options,true);

    };
    $.fn.hideerrormessage= function() {
    	methods.closePrompt(this);
    }
    $.fn.hideAll= function() {
    	methods.hideAll();
    }
